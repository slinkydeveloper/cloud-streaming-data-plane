...
import com.slinkydeveloper.cloud.streaming.runtime.api.InputStream;
import com.slinkydeveloper.cloud.streaming.runtime.api.OutputStream;
import com.slinkydeveloper.cloud.streaming.runtime.api.StreamProcessor;
...
public class AggregatorVerticle extends AbstractVerticle {
    ...
    public AggregatorVerticle(String bootstrapServers, String appId, StreamProcessor model) {
